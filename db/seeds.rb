...
Humorist.create!(name: "Tu sais, le mec la", humor_type: "Tout Public", public_target: "Enfant", price_per_hour: 1, gender: "child-friendly", owner: User.last)
Humorist.create!(name: "Norman", humor_type: "Enfantin", public_target: "Adulte", price_per_hour: 100, gender: "Envahisseur", owner: User.last)
